/**
 * Decorators - track-scroll-decorator
 *
 * ## Tracks document scroll and passes the value to the decorated component.
 *
 * Provides a `scroll` prop with the scroll value.
 */
import React from 'react'
import TrackScroll from './'

const Tracked = TrackScroll((props) => (
  <div style={{
    display: 'flex',
